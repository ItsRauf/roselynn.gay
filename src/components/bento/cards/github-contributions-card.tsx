		...
		<div className="flex flex-col gap-2">
			<div className="grid grid-rows-7 grid-flow-col gap-1 sm:gap-1.5">
				{contributions.map((day) => (
					<div
						key={day.date}
						className={`aspect-square rounded-[1px] sm:rounded-sm ${CONTRIBUTION_LEVELS[day.level]}`}
					/>
				))}
			</div>
...
export function GitHubContributionsCard() {
	return (
		<GlowCard
			className="col-span-2 sm:col-span-4 md:col-span-6 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10"
